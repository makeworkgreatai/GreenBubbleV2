...
export function BubbleBoard({
  ...
  return (
    <div className={`flex-1 flex flex-col min-h-0 ${nightMode ? "night-mode" : ""}`}>
      {/* Mobile card view */}
      ...
      {/* Desktop table view */}
      <div className={`hidden md:block overflow-auto flex-1 border-t-4 ${editMode ? "border-yellow-400" : "border-gray-400"}`}>
