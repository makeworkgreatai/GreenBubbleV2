...
const PUBLIC_PATHS = ["/login", "/api/auth/login", "/api/auth/logout", "/api/health", "/api/twilio", "/api/view", "/api/events", "/api/changelog", "/api/setup", "/view", "/changelog", "/privacy", "/terms"];
